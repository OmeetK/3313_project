          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              ...
              <nav className="hidden md:ml-10 md:flex md:space-x-8">
                ...
                <Link href="/categories" className="text-gray-700 hover:text-green-500">
                  Categories
                </Link>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-lg font-semibold mb-4">AuctionX</h3>
              <p className="text-gray-400">The most trusted marketplace for authentic items.</p>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="/category/collectibles" className="text-gray-400 hover:text-white">
                    Collectibles
                  </Link>
                </li>
                <li>
